...
This project explores customer behavior using a dataset of 1,362 entries with features like age, income, spending score, membership years, purchase frequency, and last purchase amount. 
The goal is to uncover insights that can guide business strategy, especially around customer retention and revenue growth.
